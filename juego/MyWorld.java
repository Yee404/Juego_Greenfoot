...
public class MyWorld extends World
{
    ...
    {    
       ...
       level.add(1);
       alonso = new r_car(velocidad_coche);
    ...
    public void aniadir_rivales(){
        ...
        if(num_rivales == 0){
            ...
            if(carril == 0){
                addObject(new g_car(velocidad_coche),180, 80);
            }
            else if( carril == 1){
                addObject(new g_car(velocidad_coche),290, 80);
            }
            else{
                addObject(new g_car(velocidad_coche),410, 80);
            }
